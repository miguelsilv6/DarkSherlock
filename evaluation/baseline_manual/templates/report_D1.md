...
# Baseline Manual — Investigação D1

## Metadados

- **Cenário:** D1 — Espionagem Corporativa
- **Query original:** `example-corp source code leak`
- **Investigador:** (o teu nome)
- **Início (Etapa 1, UTC):**
- **Fim (Etapa 5, UTC):**
- **Motores usados:** Ahmia ⬜ · Tor66 ⬜ · The Deep Searches ⬜ (assinala os que produziram resultados)
- **Hash global SHA-256** (`baseline_helper.py hash-global sources/D1/`):

## 1. Query: example-corp source code leak
...
- **URL:**
- **SHA-256** (`baseline_helper.py hash sources/D1/fonte1.txt`):
