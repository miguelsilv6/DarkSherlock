...
# Baseline Manual — Investigação A1

## Metadados

- **Cenário:** A1 — Threat Intel
- **Query original:** `lockbit leak site`
- **Investigador:** (o teu nome)
- **Início (Etapa 1, UTC):**
- **Fim (Etapa 5, UTC):**
- **Motores usados:** Ahmia ⬜ · Tor66 ⬜ · The Deep Searches ⬜ (assinala os que produziram resultados)
- **Hash global SHA-256** (`baseline_helper.py hash-global sources/A1/`):

## 1. Query: lockbit leak site
...
- **URL:**
- **SHA-256** (`baseline_helper.py hash sources/A1/fonte1.txt`):
